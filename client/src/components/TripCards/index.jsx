...
const TripCards = ({ trips, refetchTrips }) => {
      ...
      try {
        const { data } = await addActivity({
          variables: {
            ...
            date: dateText,
            description: descriptionNameText,
          ...
          {trips && trips.map((trip) => (
            ...
            <div key={trip._id} className="card">
              <div className="tripCard">
                ...
                <form className= 'card-container' onSubmit={handleFormSubmit}>
                  ...
                  <button onClick={() => displayForm(trip._id)} className="btn btn-block btn-primary" type="button"> {btnText}</button>
